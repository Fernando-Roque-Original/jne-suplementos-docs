---
title: Fontes e pendências do catálogo
description: Registro das fontes oficiais, licenças de imagens e dados que ainda precisam de confirmação da loja.
tags:
  - catálogo
  - fontes
  - imagens
...
# Fontes e pendências do catálogo

Esta página registra as fontes consultadas em 21 de agosto de 2026. Ela evita misturar preços de outras lojas com os preços da JNE e ajuda a conferir mudanças de embalagem.
...
| Multivitamínico Nyer           | [Nyer Nutrition](https://nyersuplementos.com/products/multi-vitaminico-nyer-nutrition)                                         | foto e apresentação                    |
...
- coqueteleiras: [Osaka protein shaker, de Karnaz](https://commons.wikimedia.org/wiki/File:Osaka_protein_shaker.jpg), CC0 1.0;
- garrafa inox: [Stainless steel water bottle, de Corn cheese](https://commons.wikimedia.org/wiki/File:Stainless_steel_water_bottle.jpg), CC BY-SA 4.0.

O aviso `Imagem de referência` permanece visível enquanto o modelo real não for fotografado. A página da garrafa também mostra a atribuição exigida pela licença.
